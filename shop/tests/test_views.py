...
class GetAllProductsTest(TestCase):
    """ Test module for GET products API """

    def setUp(self):
        self.book = Product.objects.create(
            name='book', price_in_dollars=1.23, barcode='09asd', description='Best book ever')
        self. dishwasher = Product.objects.create(
            name='dishwasher', price_in_dollars=123.1, barcode='109asd', description='Worst dishwasher ever')
        self.t_shirt = Product.objects.create(
            name='t-shirt', price_in_dollars=12.3, barcode='109tsir', description='t-shirt for ever')
